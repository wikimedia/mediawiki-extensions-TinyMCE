...
//0108    var createSegment = function (scope, listType) {
    var createSegment = function (scope, entry) {
//0108start
		var listType = entry.listType;
		var list = Element.fromTag(listType, scope);
        setAll(list, entry.listAttributes);
//0108 end		
      var segment = {
//0108        list: Element.fromTag(listType, scope),
        list: list,
...
//0108        segments.push(createSegment(scope, entry.listType));
        segments.push(createSegment(scope, entry));
      }
      return segments;
    };
    ...
    function Plugin () {
      global.add('wikilists', function (editor) {
